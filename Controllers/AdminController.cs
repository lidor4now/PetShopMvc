...
public class AdminController : Controller
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create(Animals animal, IFormFile photo)
    {
    ...
    public async Task<IActionResult> Edit(int id, IFormFile photo)
    {
        ...
        if (await TryUpdateModelAsync<Animals>(animalToUpdate, "", a => a.Name, a => a.Age, a => a.Description, a => a.CategoryId, a => a.PictureUrl))
        {
            try
            {
